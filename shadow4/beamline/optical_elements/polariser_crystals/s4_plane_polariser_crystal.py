...
from shadow4.beamline.optical_elements.polariser_crystals.s4_polariser_crystal import S4PolariserCrystalElement, S4PolariserCrystal
...
class S4PlanePolariserCrystal(S4PolariserCrystal, S4PlaneOpticalElementDecorator):
    """
    ...
    Returns
    -------
    instance of S4PlanePolariserCrystal.
    """
    def __init__(self,
                 name="Plane polariser crystal",
                 boundary_shape=None,
                 material=None,
        ...
        S4PolariserCrystal.__init__(self,
                           name=name,
...
from shadow4.beamline.optical_elements.crystals.s4_plane_crystal import S4PlanePolariserCrystal
optical_element = S4PlanePolariserCrystal(name='{name}',
...
class S4PlanePolariserCrystalElement(S4PolariserCrystalElement):
    """
    The Shadow4 plane crystal element.
    It is made of a S4PlanePolariserCrystal and an ElementCoordinates instance. It also includes the input beam.
    ...
    """
    def __init__(self,
                 optical_element : S4PlanePolariserCrystal = None,
                 coordinates : ElementCoordinates = None,
                 movements: S4BeamlineElementMovements = None,
                 input_beam : S4Beam = None):
        super().__init__(optical_element=optical_element if optical_element is not None else S4PlanePolariserCrystal(),
    ...
    def to_python_code(self, **kwargs):
        ...
        **kwargs
        ...
        txt += "\nfrom shadow4.beamline.optical_elements.crystals.s4_plane_crystal import S4PlanePolariserCrystalElement"
        txt += "\nbeamline_element = S4PlanePolariserCrystalElement(optical_element=optical_element,coordinates=coordinates, movements=movements, input_beam=beam)"
        txt += "\n\nbeam, footprint = beamline_element.trace_beam()"
        return txt

if __name__ == "__main__":
    from dabax.dabax_xraylib import DabaxXraylib
    c = S4PlanePolariserCrystal(
            name="Undefined",
            boundary_shape=None,
            material="Si",
            # diffraction_geometry=DiffractionGeometry.BRAGG, #?? not supposed to be in syned...
    ...
    ce = S4PlanePolariserCrystalElement(optical_element=c)
    print(ce.info())
    print(ce.to_python_code())

    # cc = S4PlanePolariserCrystalElement()
