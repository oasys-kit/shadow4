...
class S4ParaboloidGrating(S4Grating, S4ParaboloidOpticalElementDecorator):
    def __init__(self,
...
class S4ParaboloidGratingElement(S4GratingElement):
    def __init__(self,
        ...
        super().__init__(optical_element=optical_element if optical_element is not None else S4ParaboloidGrating(),
    ...
    def to_python_code(self, **kwargs):
        ...
        txt += "\nfrom shadow4.beamline.optical_elements.gratings.s4_paraboloid_grating import S4ParaboloidGratingElement"
        txt += "\nbeamline_element = S4ParaboloidGratingElement(optical_element=optical_element, coordinates=coordinates, movements=movements, input_beam=beam)"
...
if __name__ == "__main__":
    ...
    ge = S4ParaboloidGratingElement(optical_element=g, coordinates=coordinates_syned, input_beam=beam)
