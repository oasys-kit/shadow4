...
class S4ParaboloidMultilayer(S4Multilayer, S4ParaboloidOpticalElementDecorator):
    ...
    surface_calculation : int, optional
        flag:
            ...
            1 = SurfaceCalculation.EXTERNAL (surface computed from parabola_parameter, pole_to_focus).
    ...
    at_infinity : int (as defined by Side), optional
        Used for both surface_calculation=0 and 1, flag to indicate that:
    ...
    parabola_parameter : float, optional
        For surface_calculation=1 (EXTERNAL), the parabola parameter PARAM (y^2 = 2 PARAM z)
