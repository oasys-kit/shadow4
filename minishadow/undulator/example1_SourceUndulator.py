...
if __name__ == "__main__":
    ...
    u.set_from_keywords(E_ENERGY=6.04,INTENSITY=0.2,FLAG_EMITTANCE=0,SX=0.04,SZ=0.001,SXP=10e-6,SZP=4e-6,
                        LAMBDAU=0.032,NPERIODS=50,K=0.25,
                        EMIN= 10498.0000,EMAX= 10499.0000,
                        NG_E=11,MAXANGLE=0.1,NG_T=51,NG_P=11,N_J=20,
